...
async function fixture() {
  ...
  await client.query(`
    ...
    CREATE TEMP TABLE payments (id uuid PRIMARY KEY, order_id uuid, status varchar, created_at timestamptz NOT NULL DEFAULT now());
...
test("payment status protects cancelled orders, audits real changes, and respects permissions", async () => {
  ...
  try {
    ...
    await f.client.query("INSERT INTO pg_temp.orders(id,status) VALUES ($1,'cancelled'),($2,'ready'),($3,'ready')", [id(10), id(11), id(12)]);
    await f.client.query("INSERT INTO pg_temp.payments(id,order_id,status,created_at) VALUES ($1,$2,'pending','2026-01-01'),($3,$4,'pending','2026-01-02'),($5,$6,'paid','2026-01-03')", [id(20), id(10), id(21), id(11), id(22), id(12)]);
    ...
    assert.deepEqual(auditRows, [{ entity_id: id(11), details: { before: "pending", after: "paid" } }]);
