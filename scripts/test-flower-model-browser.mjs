...
export default function Page() {
 ...
 {mode==="admin" ? <AdminFlowerModel flowerId="9223372036854775700" initialModel={model}/> : mode==="builder" ? <div style={{height:950}}><BouquetConstructorLoader flowers={flowers} legacyLinks={{}} wrappings={[{id:"1",slug:"blush",name:"Пудровая",subtitle:"Нежная",color:"#f4cfc8",ribbonColor:"#b85d70",salePrice:25,opacity:0.5,sortOrder:10}]}/></div> : <div style={{height:750}}><AdminBouquetViewerCanvas viewMode="3d" configuration={mode==="legacy" ? {schemaVersion:1,wrappingKind:"blush",flowers:[{id:"legacy",kind:"rose",position:[0,0,0],rotation:[0,0,0]}]} : {schemaVersion:2,wrappingKind:"blush",flowers:[{id:"saved",flowerId:flowers[0].id,position:[0,0,0],rotation:[0,0,0],snapshot:{name:flowers[0].name,salePrice:12,color:null,imageUrl:null,model}}]}}/></div>}</>;
}`, { flag: "wx" });
